...
button17 = tkinter.Button(frame,text='x'+chr(178),font=('Courier','14'),
                         command=lambda: calc('x^2'))
button17.grid(row=1,column=5)
button18 = tkinter.Button(frame,text=chr(8730),font=('Courier','14'),
                         command=lambda: calc('squared'))
